...
func TestTogglClient_FetchEntries_TaskInDesc(t *testing.T) {
	start := time.Date(2021, 10, 2, 0, 0, 0, 0, time.UTC)
	end := time.Date(2021, 10, 2, 23, 59, 59, 0, time.UTC)
	...
	expectedEntries := worklog.Entries{
		{
			...
			Summary:            "CPT-2014 I met with The Winter Soldier",
			Notes:              "CPT-2014 I met with The Winter Soldier",
			Start:              start,
			BillableDuration:   time.Second * 3600,
			UnbillableDuration: 0,
		},
		{
			...
			Summary:            "CPT-2014 CPT-MISC I helped him to get back on track",
			Notes:              "CPT-2014 CPT-MISC I helped him to get back on track",
			Start:              start,
			BillableDuration:   0,
			UnbillableDuration: time.Second * 1800,
		},
	...
	mockServer := newMockServer(t, &mockServerOpts{
		...
		ResponseData: &toggl.FetchResponse{
			...
			Data: []toggl.FetchEntry{
				{
					Client:      "My Awesome Company",
					Description: "CPT-2014 I met with The Winter Soldier",
					Duration:    3600000,
					IsBillable:  true,
					Project:     "MARVEL",
					ProjectID:   456,
				...
				{
					Client:      "My Awesome Company",
					Description: "CPT-2014 CPT-MISC I helped him to get back on track",
					Duration:    3600000,
					IsBillable:  false,
					Project:     "MARVEL",
					ProjectID:   456,
...
func TestTogglClient_FetchEntries_TaskInProject(t *testing.T) {
	start := time.Date(2021, 10, 2, 0, 0, 0, 0, time.UTC)
	end := time.Date(2021, 10, 2, 23, 59, 59, 0, time.UTC)
